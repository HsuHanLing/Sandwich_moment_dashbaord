    ...
    <div style={{ height: 300 }}>
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
          ...
          <YAxis yAxisId="right" orientation="right" tick={{ fontSize: 10, fill: "var(--secondary-text)" }} />
          ...
          <Line yAxisId="right" type="monotone" dataKey="avg_msgs_per_session" stroke="#f59e0b" name="Avg Msgs/Session" dot={false} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
